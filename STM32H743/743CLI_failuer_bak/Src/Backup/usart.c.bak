...
extern osMutexId myMutex01Handle;
    static char log_buf[configCOMMAND_INT_MAX_OUTPUT_SIZE];
/* USER CODE END 0 */
...
//osSemaphoreWait(myBinarySem01Handle, osWaitForever) ;
    ...
    if (length > configCOMMAND_INT_MAX_OUTPUT_SIZE - 1)
        length = configCOMMAND_INT_MAX_OUTPUT_SIZE - 1;
		
 	HAL_UART_Transmit(&huart3, (uint8_t*)log_buf, length, 1000);
    va_end(args);
